...
#
# 将交叉编译好的 macOS 二进制与资源打包为
# gqy-<tag>-<triple>.tar.gz，供 Release 附件上传。
#
# 用法：
#   scripts/package-macos.sh <tag> <triple> <release_binary_path>
set -euo pipefail
...
# 随包附带 brew formula 模板与说明，便于手动排查（可选）
