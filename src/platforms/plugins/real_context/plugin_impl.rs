...
impl RealContextPlugin {
    ...
    pub fn store(&self, context: &PlatformTurnContext) -> HistoryStore {
        message_history::store_for_paths(&context.paths)
    }

    pub fn watermark_scope(context: &PlatformTurnContext) -> crate::state::PlatformPluginScopeKey {
    ...
    pub fn reply_watermark(&self, context: &PlatformTurnContext) -> Option<i64> {
        context
            .state_store
    ...
    pub fn store_reply_watermark(&self, context: &PlatformTurnContext, high: i64) {
    ...
    pub async fn decide_group_trigger(
        &self,
        context: &PlatformTurnContext,
    ...
    pub async fn commit_direct_reply(
        &self,
        context: &PlatformTurnContext,
        event: &PlatformInboundEvent,
        settings: &RealContextPluginSettings,
    ...
    pub fn register_committed_pending(
        &self,
        session_key: &str,
        sender_id: &str,
        trigger: TriggerKind,
    ...
    pub fn cancel_reaction_expiration(
        &self,
        context: &PlatformTurnContext,
        message_id: &str,
        reaction_id: &str,
    ...
    pub fn drop_pending(&self, session_key: &str, sender_id: &str, generation: u64) -> bool {
        let mut runtime = self.runtime.lock().unwrap();
    ...
    pub fn is_current_pending(&self, session_key: &str, sender_id: &str, generation: u64) -> bool {
        self.runtime
            .lock()
            .unwrap()
            .sessions
    ...
    pub async fn clear_cancelled_pending(&self, context: &PlatformTurnContext, sender_id: &str) {
        let session_key = runtime_session_key(context);
        let reactions = {
            let mut runtime = self.runtime.lock().unwrap();
