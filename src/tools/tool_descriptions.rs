...
macro_rules! tool_description_files {
    () => {
        [
            ...
            include_str!("descriptions/brew_check_status.json"),
            include_str!("descriptions/brew_get_package_info.json"),
            include_str!("descriptions/brew_search_packages.json"),
            ...
            include_str!("descriptions/create_skill.json"),
            ...
            include_str!("descriptions/delete_skill.json"),
            ...
            include_str!("descriptions/install_brew_package.json"),
            include_str!("descriptions/list_alarms.json"),
            include_str!("descriptions/list_skill_drafts.json"),
            ...
            include_str!("descriptions/publish_skill.json"),
            include_str!("descriptions/query_api_quota.json"),
            include_str!("descriptions/query_applegamingwiki.json"),
            ...
            include_str!("descriptions/review_brew_package.json"),
            ...
            include_str!("descriptions/update_skill.json"),
